 ...
 */
public class AMixedArithmeticDemoerAndTester extends APalindromeBasedDemoerAndTester {
	
	//	 String[] args ;
	public final  String TEST_DIR = "Test Data/Test C";
	public final  String CORRECT_DIR = "Test Data/Correct C";

	public AMixedArithmeticDemoerAndTester(String[] anArgs) {
		super(anArgs);
	}
...
//		Tracer.setKeywordPrintStatus(DirectoryUtils.class, true);
		GraderDemoerAndTester aDemoerAndTester = new AMixedArithmeticDemoerAndTester(anArgs);
//		args = anArgs;
		Tracer.info(AMixedArithmeticDemoerAndTester.class, "test");
