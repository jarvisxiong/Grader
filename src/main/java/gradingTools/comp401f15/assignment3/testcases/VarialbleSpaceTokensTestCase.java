...
public class VarialbleSpaceTokensTestCase extends AbstractTokensTestCase {

    public VarialbleSpaceTokensTestCase() {
        super("Quoted String Token Test Case");
    }
    
    protected String simplifiedInputWithNoEndingSpace() { return "hello \"h e l l o\" 10 goodbye  \"go odb ye\" 20\n.\n";}
