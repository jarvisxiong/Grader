...
public class NumberEchoTestCase extends TokenScanningTestCase{

	public NumberEchoTestCase() {
        super("Number echo test case");
    }
...
//    String[] constructorArgs1 = {};
   ...
   protected String[] expectedOutputs() { return new String[] {".*00220.*", ".*32.*", ".*45.*" };};
