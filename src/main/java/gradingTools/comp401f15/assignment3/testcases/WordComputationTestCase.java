...
public class WordComputationTestCase extends TokenScanningTestCase{

	public WordComputationTestCase() {
        super("Word computation test case");
    }
...
//    String[] constructorArgs1 = {};
   ...
   protected String[] expectedOutputs() { return new String[] {".*camelcase.*", ".*anotherword.*", ".*wordword.*" };};
