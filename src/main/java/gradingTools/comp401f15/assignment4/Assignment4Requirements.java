...
public class Assignment4Requirements extends FrameworkProjectRequirements {
    ...
    public Assignment4Requirements() {
    	...
    	addFeature("Command Classes Implemented", 13,
        ...
        addFeature("Every Command Has Its Own Class", 30, new UniqueCommandClassesTestCase());
    	...
    	addFeature("Rotating line", 10, true,
    			new RotatingLineDefinedTestCase(),
    			new RotatingLineStructurePatternTestCase()
    			);
        addFeature("Rotating fixed line", 15, true,
                        new RotatingFixedLineMethodsTestCase() // add execution tests
                        );
        addFeature("Rotating moving line", 10, true,
                        new RotatingMovingLineMethodsTestCase() // add execution tests
                        );
        
        addManualFeature("Object Editor rotating line", 2, true, new ManualTestCase("Does the line rotate?"));
