...
public class QuotedStringTokensTestCase extends AbstractTokensTestCase {

    public QuotedStringTokensTestCase() {
    ...
    protected String inputWithStartingAndEndingSpace() {return  " shello \"h e l l o\" 10 goodbye  \"go odb ye\" 20\n.\n";}

 
//    String[] expectedOutputs = {"30", "200", "90", "2000"};
    protected String[] expectedOutputs() {
    	return new String[] {".*h e l l o.*", ".*go odb ye.*"};
    }
