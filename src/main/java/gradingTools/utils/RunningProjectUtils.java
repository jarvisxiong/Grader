...
public class RunningProjectUtils {
	 ...
	 * newline character
	 */
	public static BasicRunningProject runProject(Project project, int timeout, String... inputs)
	...
	public static BasicRunningProject runProject(Project project, int timeout, InputGenerator anOutputBasedInputGenerator,
			String... inputs)
			throws NotRunnableException {
		return runProject(project, DEFAULT_INPUT_SEPARATOR, timeout, anOutputBasedInputGenerator, inputs);
	}
	public static BasicRunningProject runProject(Project project, String inputSeparator, int timeout, String... inputs) throws NotRunnableException {
	 ...
	 */
	public static BasicRunningProject runProject(Project project, String inputSeparator, int timeout, InputGenerator anOutputBasedInputGenerator, String... inputs) throws NotRunnableException {
//		String allInputsStr = "";
//		for (int i = 0; i < inputs.length; i++) {
//			if (i > 0) {
//				allInputsStr += inputSeparator;
...
//		}
	...
	public static BasicRunningProject runProject(Project project,  int timeout, InputGenerator anOutputBasedInputGenerator, Map<String, String> aProcessToInput) throws NotRunnableException {
//		String allInputsStr = "";
//		for (int i = 0; i < inputs.length; i++) {
//			if (i > 0) {
//				allInputsStr += inputSeparator;
...
//		}
	...
	public static BasicRunningProject runProject(Project project, int timeout,  Map<String, String> aProcessToInput) throws NotRunnableException {
//		String allInputsStr = "";
//		for (int i = 0; i < inputs.length; i++) {
//			if (i > 0) {
//				allInputsStr += inputSeparator;
