...
//		changeOverallNotes3();
	...
	public static void waitForStepper1() {
	...
	public static void waitForNavigator2() {
...
//	}
	...
	static void waitForUserOrMediumSleep() {
		if (clearanceManager.isAutoProceed())
