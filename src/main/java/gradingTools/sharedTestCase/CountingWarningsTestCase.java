...
public abstract class CountingWarningsTestCase extends CheckStyleTestCase {
	public static final double DEFAULT_PENALTY_PER_MISTAKE = 0.2;
	protected double penaltyPerMistake = DEFAULT_PENALTY_PER_MISTAKE;

	public CountingWarningsTestCase(String aTypeName, String aMessage) {
		super(aTypeName, aMessage);
	}
	
	public CountingWarningsTestCase(String aTypeName, String aMessage, double aPenaltyPerMistake) {
		super(aTypeName, aMessage);
