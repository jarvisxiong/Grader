...
//		ObjectEditor.setPropertyAttribute(AnOnyenRangeModel.class, "endingOnyen",  AttributeNames.STRETCHABLE_BY_PARENT, true);
		...
		ObjectEditor.setPropertyAttribute(ANavigationFilterSetter.class, "FilterOptions",  AttributeNames.LABEL_POSITION, AttributeNames.LABEL_IN_BORDER);
		ObjectEditor.setPropertyAttribute(ANavigationFilterSetter.class, "FilterOptions",  AttributeNames.DIRECTION, AttributeNames.HORIZONTAL);
