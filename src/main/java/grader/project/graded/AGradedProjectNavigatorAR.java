...
public class AGradedProjectNavigatorAR implements ExecutableCommand{
...
//		ObjectEditor.setPropertyAttribute(AGraderFilesSetterModel.class, "TextEditor", AttributeNames.LABEL_WIDTH, 90);
		ObjectEditor.setAttribute(AGradedProjectNavigator.class, AttributeNames.STRETCHABLE_BY_PARENT, false);

//		ObjectEditor.setPropertyAttribute(AGradedProjectNavigator.class, "*", AttributeNames.STRETCHABLE_BY_PARENT, false);
//
//		ObjectEditor.setMethodAttribute(AGradedProjectNavigator.class, "*", AttributeNames.STRETCHABLE_BY_PARENT, false);
