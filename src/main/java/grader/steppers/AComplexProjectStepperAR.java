...
//			ObjectEditor.setMethodAttribute(AMainProjectStepper.class, "*", AttributeNames.VISIBLE, false);
			...
			ObjectEditor.setPropertyAttribute(AComplexProjectStepper.class, "SourceChecks", AttributeNames.SCROLLED, true);
			ObjectEditor.setPropertyAttribute(AComplexProjectStepper.class, "SourceChecks", AttributeNames.ACTION_MODE, true);
