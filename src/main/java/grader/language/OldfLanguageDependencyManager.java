...
public class OldfLanguageDependencyManager  {
	...
	public static void setSourceFileSuffix(String sourceFileSuffix) {
		OldfLanguageDependencyManager.sourceFileSuffix = sourceFileSuffix;
	}


	public static void setLanguageToSourceFileSuffix(
			Map<String, String> languageToSourceFileSuffix) {
		OldfLanguageDependencyManager.languageToSourceFileSuffix = languageToSourceFileSuffix;
	}
	...
	public static void setLanguage(String language) {
		OldfLanguageDependencyManager.language = language;
	...
	public static void setBinaryFileSuffix(String binaryFileSuffix) {
		OldfLanguageDependencyManager.binaryFileSuffix = binaryFileSuffix;
	}
