...
public class Program3 {
	...
	public static void main(String args[]) {
		...
		while (true) {
			...
			if ("check if palindrome".equalsIgnoreCase(option)) {

				System.out.println(isPalindrome(input) + "\n");

			} else if ("compute rounded sum".equalsIgnoreCase(option)) {

				System.out.println(computeRoundedSum(input) + "\n");

			} else if ("count unique characters".equalsIgnoreCase(option)) {

				System.out.println(countUniqueCharacters(input) + "\n");

			} else if ("reverse word characters".equalsIgnoreCase(option)) {
