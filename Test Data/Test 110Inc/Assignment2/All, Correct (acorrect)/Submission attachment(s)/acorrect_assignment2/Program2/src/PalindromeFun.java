...
public class PalindromeFun {
	...
	public static void main(String[] args) {
		...
		if(inputString.length() > 8 || inputString.length() < 1)
		{
		...
		for(int i=0; i < inputString.length() / 2; i++)
			if(Character.toUpperCase(inputString.charAt(i)) != Character.toUpperCase(inputString.charAt(inputString.length() - 1 - i)))
			{
